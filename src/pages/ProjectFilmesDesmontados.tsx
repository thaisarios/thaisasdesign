    ...
    <div className="bg-background text-foreground overflow-x-hidden">
      ...
      <header className="fixed top-0 left-0 right-0 z-50 backdrop-blur-md bg-background/60 border-b border-border/20">
        <div className="container mx-auto px-6 md:px-12 h-16 flex items-center justify-between">
          <Link to="/" data-hover aria-label={common.back} className="flex items-center gap-2 font-mono-alt text-xs uppercase tracking-[0.25em] text-foreground/70 hover:text-secondary transition-colors">
          ...
          <span className="font-mono-alt text-xs uppercase tracking-[0.25em] text-muted-foreground hidden sm:block mr-[72px] md:mr-[84px]">{c.caseCount}</span>
        </div>
      </header>
